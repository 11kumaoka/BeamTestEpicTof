...
class LGADHitCalibration_beamTest_factory
    : public JOmniFactory<LGADHitCalibration_beamTest_factory, LGADHitCalibrationConfig_beamTest> {
private:
  std::unique_ptr<eicrecon::LGADHitCalibration_beamTest> m_algo;
...
public:
  void Configure() {
    m_algo = std::make_unique<eicrecon::LGADHitCalibration_beamTest>(GetPrefix());
